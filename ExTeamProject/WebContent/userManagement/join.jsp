...
<head>
	...
	<script type="text/javascript">
		...
		window.open("./userManagement/emailCheckForm.jsp", "EmailCheck", "width=400, height=300, top=250, left=800");
		}
		...
		// 다시 중복체크를 하도록 한다.
			function inputIdChk(){
			document.userInfo.idDuplication.value ="user_emailcheck";
		}		
	</script>
</head>
			...
			<table class="table table-bordered table-hover" style="text-align: center; border: 1px solid #dddddd">
				...
				<tbody>
					<tr>
						...
						<td>
							<input class="form-control" type="email" id="user_email" name="user_email" maxlength="20" placeholder="이메일을 입력해주세요" onkeydown="inputIdChk()">
						</td>
						<td style="width: 110px;">
							<button class="btn btn-primary" onclick="openIdChk();" type="button">중복체크</button>
							<!-- 아이디중복체크했는지 하지 않았는지에 대한 값  0:하지 않음, 1:함 -->
							<input type="hidden" name="idDuplication" id="user_emailCheck" value="user_emailcheck"/>
						</td>
					</tr>
					<tr>
						<td style="width: 110px;">
					...
					<tr>
						...
						<td colspan="2">
							<input class="form-control" type="password" id="user_passcheck" name="user_passcheck" maxlength="20" placeholder="비밀번호 확인을 입력해주세요">
						</td>
					</tr>
					<tr>
						<td style="width: 110px;">
						...
						<td colspan="2">
							<input class="form-control" type="text" id="user_nickname" name="user_nickname" maxlength="20" placeholder="닉네임을 입력해주세요"></td>
					</tr>
					<tr>
						<td style="width: 110px;">
							<h5>생년월일</h5>
						...
						<td colspan="2">
							<input class="form-control" type="text" id="user_birth" name="user_birth" maxlength="20" placeholder="생년월일을 입력해주세요" ex)941111>
						</td>
					</tr>
					<tr>
						<td style="width: 110px;">
							...
							<div class="form-group" style="text-align: center; margin:0 auto;">
								<div class="btn-group" data-toggle="buttons">
									...
									<label class="btn btn-primary">
										<input type="radio" name="user_gender" autocomplete="off" value="여">여자
									</label>
								</div>
							</div>
						</td>
