		...
		<h2 class="signUpTitle" id="login_label">비밀번호 찿기</h2>
			<table id="na_metable">
				<tr>
					...
					<td><input class="signUpInput" name="mem_name" id="mem_name" placeholder="닉네임 입력" size="20" /></td>
				</tr>
				<tr>
					<th><label for="email"></label></th>
					<td><input class="signUpInput" type="text" name="mem_email" id="mem_email" placeholder="이메일 입력" size="20"></td>
				</tr>
				<tr align="center">
					<td colspan="2"><br /> 
