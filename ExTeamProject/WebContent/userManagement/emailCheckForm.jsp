...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
	...
	<script type="text/javascript">
		...
		function pValue(){
			document.getElementByEmail("user_email").value = opener.document.userInfo.email.value;
		}
...
<div id="wrap">
	...
	<br>
	<div class="total">
		<form id="checkForm" action="IdCheckForm.jsp" method="post" name="wfr">
			<input type="text" name="userid" id="userid" readonly >
			<input type="submit" value="중복확인" id="007" onclick="idCheck()">
		</form>
