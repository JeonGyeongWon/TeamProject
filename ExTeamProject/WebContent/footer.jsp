...
<body>
	...
	<!-- jQuery Easing -->
	<script src="/ExTeamProject/js/jquery.easing.1.3.js"></script>
	<!-- Bootstrap -->
	<script src="/ExTeamProject/js/bootstrap.min.js"></script>
	<!-- Carousel -->
	<script src="/ExTeamProject/js/owl.carousel.min.js"></script>
	<!-- Stellar -->
	<script src="/ExTeamProject/js/jquery.stellar.min.js"></script>
	<!-- Waypoints -->
	<script src="/ExTeamProject/js/jquery.waypoints.min.js"></script>
	<!-- Counters -->
	<script src="/ExTeamProject/js/jquery.countTo.js"></script>
	
	
	<!-- MAIN JS -->
	<script src="/ExTeamProject/js/main.js"></script>
</body>
</html>