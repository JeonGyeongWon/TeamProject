    ...
    <script src="https://code.jquery.com/jquery-3.3.1.js"></script>
     ...
     <%
    //인증번호 확인과, registerForm에게 돌려줄 핸드폰번호를 받아옴
    ...
    function AuthSMS(){
    	...
    	if(ckSMS!=<%=msgCk%>){
    		...
    		return false;
	   		...
	   		// ajax를 사용하여 해당 유저에 핸드폰 정보를 추가한다.
     ...
     */
     ...
     /*  cafe24에 있는 2번째 예제소스를 불러온다.
     
     	2. 밑에 부분에 설정해준다.
     	String user_id = base64Encode("서비스신청한 아이디"); 
        String secure = base64Encode("인증키");	
        
        이후 3번째 소스를 불러와서 calljson.jsp 파일을 만들어준다 -> *파일명은 그대로사용하는걸 권장하고있다.
    ...
    if(action.equals("go")) {
    	//http://localhost:8080/Project12/user/SMSAuthProc.jsp
        String sms_url = "";
        sms_url = "https://sslsms.cafe24.com/sms_sender.php"; // SMS 전송요청 URL
        String user_id = base64Encode("janua97"); // SMS아이디
        String secure = base64Encode("e6cb20504cf8609a40240edbec73927b");//인증키
